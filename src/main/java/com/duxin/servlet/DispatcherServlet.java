package com.duxin.servlet;

import com.duxin.annotation.*;
import com.duxin.controller.SpringmvcController;
import java.io.File;
...
public class DispatcherServlet extends HttpServlet{
    ...
    public static void main(String[] args){
        ...
        dispatcherServlet.scanPackage("com.duxin");
        try {
            dispatcherServlet.filterAndInstance();
        }catch (Exception e){

        }
        dispatcherServlet.handerMap();
...
//                    field.setAccessible(true);
        ...
        SpringmvcController duxin = (SpringmvcController) instanceMap.get("duxin");
